...
function BuildTodo(id, title, checked = false){
    ...
    <div class="todo-list__todo ${checked != false ?'completed':''}"  data-id=${id}>
        ...
        <div class='options'>
            <div data-id=${id} class="edit"><img class="edit" data-id=${id} src="images/edit.png" alt=""></div>
            <div data-id=${id} class="delete"><img id='delete' class='delete' data-id=${id} src="images/bin.png" alt=""></div>
        </div>
    </div> `;
}
// Global 
